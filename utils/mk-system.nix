...
let
  ...
  commonArgs = {
    ...
    specialArgs = {
      ...
      inherit (inputs) nixpkgs nix-darwin home-manager sops-nix nixos-raspberrypi nixos-wsl nur lanzaboote mac-app-util nix-homebrew homebrew-core homebrew-cask homebrew-extras homebrew-koekeishiya apple-fonts apple-emoji-linux catppuccin hyprland yazi wezterm fancontrol-gui fenix dotfiles-private;
    };
  };
