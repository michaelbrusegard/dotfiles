...
# Set wallpaper
osascript -e 'tell application "System Events" to tell every desktop to set picture to POSIX file "'"$(find "$(dirname "$(realpath "$0")")/../../shared/resources" \( -name "*current.png" -o -name "*current.jpg" \) | head -n 1)"'"'
