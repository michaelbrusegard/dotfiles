...
table.insert(plugins, {
	...
	config = function()
		...
		smartsplits:setup()
		vim.keymap.set({ "n", "v", "i", "c", "t", "o" }, "<Char-0xAA>", smartsplits.move_cursor_left)
		vim.keymap.set({ "n", "v", "i", "c", "t", "o" }, "<Char-0xAB>", smartsplits.move_cursor_down)
		vim.keymap.set({ "n", "v", "i", "c", "t", "o" }, "<Char-0xAC>", smartsplits.move_cursor_up)
		vim.keymap.set({ "n", "v", "i", "c", "t", "o" }, "<Char-0xAD>", smartsplits.move_cursor_right)
		vim.keymap.set({ "n", "v", "i", "c", "t", "o" }, "<Char-0xBA>", smartsplits.resize_left)
		vim.keymap.set({ "n", "v", "i", "c", "t", "o" }, "<Char-0xBB>", smartsplits.resize_down)
		vim.keymap.set({ "n", "v", "i", "c", "t", "o" }, "<Char-0xBC>", smartsplits.resize_up)
		vim.keymap.set({ "n", "v", "i", "c", "t", "o" }, "<Char-0xBD>", smartsplits.resize_right)
	end,
})
