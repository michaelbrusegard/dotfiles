...
-- It needs the following dependencies: pynvim jupytext jupyter_client ipykernel plotly kaleido cairosvg pnglatex pyperclip pillow git+https://github.com/quarto-dev/quarto-cli
