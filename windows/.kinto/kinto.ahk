...
; Functions to fix sticky windows key
RunAndReleaseWinKey(commands*) {
...
; Focus window
$!h::RunAndReleaseWinKey("komorebic focus left")
$!j::RunAndReleaseWinKey("komorebic focus down")
$!k::RunAndReleaseWinKey("komorebic focus up")
$!l::RunAndReleaseWinKey("komorebic focus right")

; Move window
$!+h::RunAndReleaseWinKey("komorebic move left")
$!+j::RunAndReleaseWinKey("komorebic move down")
$!+k::RunAndReleaseWinKey("komorebic move up")
...
; HJKL for arrow keys outside terminals with repeat functionality
...
; Caps Lock to Escape in Terminal
#IfWinActive ahk_group Terminals
    $CapsLock::Esc
#If
